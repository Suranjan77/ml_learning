...
export const backpropExhibit: ExhibitDefinition = {
  ...
  ], challenges: ["Find inputs that make one hidden unit much more active than the other.", "Flip the target and explain why every output-layer gradient changes sign."], component: BackpropScene,
};
