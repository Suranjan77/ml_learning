...
export const decisionTreeExhibit: ExhibitDefinition = {
  ...
  steps: [
    ...
    { title: "Move the root", instruction: "Drag the first threshold and watch every downstream region inherit the changed boundary.", observation: "An early split has global consequences because it decides which later rules an example can reach." },
  ],
